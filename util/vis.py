...
class Visualizer:
    ...
    @classmethod
    def visualize_prediction_one(cls, qry_img_b, qry_mask_b, dir_name="./"):

        qry_img_b = to_cpu(qry_img_b)
        qry_mask_b = to_cpu(qry_mask_b)

        cls.visualize_prediction_me(qry_img_b, qry_mask_b, dir_name)
    ...
    @classmethod
    def visualize_prediction_me(cls, qry_img, qry_mask, dir_name="./"):

        color1 = cls.colors['blue']
        qry_color = cls.colors['green']
        color2 = cls.colors['red']
        ...
        qry_masked_pil.save('D:/document/桌面/' + 'maaaa_mask' + '.png')
